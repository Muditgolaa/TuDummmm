  ...
  return (
    <div className="min-h-screen grid place-items-center px-4">
      <div className="w-full max-w-sm bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-7">
        <h1 className="font-display text-3xl font-extrabold text-[var(--text)]">Create account</h1>
        <p className="text-sm text-[var(--muted)] mt-1 mb-6">Start building your streak and practicing interviews.</p>
        ...
        <p className="mt-6 text-center text-sm text-[var(--muted)]">
          Already have an account? <Link to="/login" className="font-semibold text-[var(--amber)] hover:underline">Log in</Link>
        </p>
      </div>
    </div>
  );
